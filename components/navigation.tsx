  ...
  return (
    ...
    >
      ...
      >
        ...
        <a
          href={getNavPath("/")}
          className="text-sm font-bold tracking-[-0.02em] text-foreground hover:opacity-80 transition-opacity duration-200"
        >
          NK<span className="text-muted-foreground/50">.</span>
        </a>
